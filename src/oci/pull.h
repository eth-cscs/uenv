...
// a truncated or corrupt download is caught locally. `image` is the parsed image
// manifest. An optional abort predicate, polled during the download, cancels it
// (for Ctrl-C handling).
...
pull_meta(client& c, const digest& manifest_digest,
